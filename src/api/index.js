...
//获取用户地址信息 （由于数据库没有值，所以采用mock模拟返回数据）
//URL:/api/user/userAddress/auth/findUserAddressList  method:get
// export const reqAddressInfo = ()=>requests({url:'/user/userAddress/auth/findUserAddressList',method:'get'});
export const reqAddressInfo = ()=>mockRequests({url:'/user/userAddress/auth/findUserAddressList',method:'get'});
//获取商品清单（由于数据库没有值，所以采用mock模拟返回数据）
//URL:/api/order/auth/trade   method:get
// export const reqOrderInfo = ()=>requests({url:'/order/auth/trade',method:'get'});
export const reqOrderInfo = ()=>mockRequests({url:'/order/auth/trade',method:'get'});
//提交订单的接口
